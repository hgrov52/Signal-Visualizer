%% Usage: maxlevel(inputfile)
%%
%% max level returns the maximum amplitude from fft spectrum in decibels
%%
...
function result = maxlevel(inputfile)
...
result = max(20 * log10(abs_result));
